...
appModule.config([
    ...
    function ($stateProvider, $urlRouterProvider, $qProvider) {
        $stateProvider.state('tenant.imageboard', {
            url: '/imageboard',
            templateUrl: '~/App/tenant/views/imageboard/index.cshtml'
        });
        ...
        $stateProvider.state('thread', {
            url: '/thread/?id=',
            templateUrl: '~/App/tenant/views/imageboard/thread.cshtml',
            controller: 'tenant.views.imageboard.thread as vm'
        });
